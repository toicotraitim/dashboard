            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div id="outputFile" style="display: inline-block;">
                        <img id="output" src="{{ $category['category_thumb'] == null ? asset('storage/thumbnail.png') : asset($category['category_thumb']) }}" alt="" class="mt-2" style="width: 200px; height: 200px; object-fit: cover">
                    </div>
                </div>
